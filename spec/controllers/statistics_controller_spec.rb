...
describe StatisticsController do
  ...
  describe '#top_ten' do
    it 'returns a list of most liked posts' do
      FactoryBot.create_list(:post, 9, likes: 9)
      FactoryBot.create(:post, likes: 10, title: 'Popular post!')
  ...
  describe '#posts_per_day' do
    it 'returns labels and counts for our post activity' do
      ...
      FactoryBot.create_list(:post, 3, published_at: yesterday)
      FactoryBot.create_list(:post, 5, published_at: today)
